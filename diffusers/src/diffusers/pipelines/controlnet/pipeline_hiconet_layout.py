...
class StableDiffusionHicoNetLayoutPipeline(
    ...
    Args:
        ...
        hiconet ([`ControlNetModel`] or `List[ControlNetModel]`):
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if infer_mode == "single":
                    ...
                    control_model_input = torch.repeat_interleave(control_model_input, repeats=BNS, dim=0)  # [4*2, 4, 64, 64]
